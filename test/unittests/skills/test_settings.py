...
from mycroft.skills.settings import (SettingsMetaUploader,
                                     ...
                                     get_local_settings, save_settings)
...
class TestSettingsMetaUploader(MycroftUnitTestBase):
    ...
    def setUp(self):
        ...
        self.skill_metadata = dict(skillMetadata=dict(sections=[
            dict(
                name="Test Section",
    ...
    def _check_settingsmeta(self, skill_settings=None):
        ...
        self.assertDictEqual(expected_settings_meta,
...
class TestSettingsDownloader(MycroftUnitTestBase):
    ...
    def test_download_failed(self):
        ...
        self._check_timer_called()
        self._check_no_message_bus_events()
        self.assertEqual(pre_download_local_settings,
    ...
    def _check_api_called(self):
        self.assertListEqual([call.get_skill_settings()],
    ...
    def _check_message_bus_events(self, remote_skill_settings):
        self.assertListEqual(["mycroft.skills.settings.changed"],
                             self.message_bus_mock.message_types)
        self.assertListEqual([remote_skill_settings],
...
class TestSettings(TestCase):
    ...
    def test_empty_settings(self):
        settings = get_local_settings(self.skill_mock.root_dir,
