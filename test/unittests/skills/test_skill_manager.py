...
class TestSkillManager(MycroftUnitTestBase):
    ...
    def _mock_skill_settings_downloader(self):
        settings_download_patch = patch(self.mock_package +
    ...
    def _mock_skill_updater(self):
        skill_updater_patch = patch(self.mock_package + "SkillUpdater",
                                    spec=True)
    ...
    def test_instantiate(self):
        self.assertEqual(self.skill_manager.config["data_dir"],
                         str(self.temp_dir))
        expected_result = [
    ...
    def test_send_skill_list(self):
        ...
        self.assertListEqual(["mycroft.skills.list"],
    ...
    def test_handle_converse_request(self):
        ...
        converse_response_mock.assert_called_once_with(True, message,
    ...
    def test_converse_request_missing_skill(self):
        ...
        converse_error_mock.assert_called_once_with(message, "foo",
    ...
    def test_load_on_startup(self):
        ...
        self.assertListEqual(["mycroft.skills.initialized"],
                             self.message_bus_mock.message_types)
