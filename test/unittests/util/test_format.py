...
from mycroft.util.format import (TimeResolution, date_time_format, join_list,
...
class TestNiceDurationFuncs(unittest.TestCase):
    def test_nice_duration(self):
        ...
        self.assertEqual(
            nice_duration(360000.254325,
                          resolution=TimeResolution.MILLISECONDS,
                          speech=False),
            "4d 4:00:00.254",
        )
        self.assertEqual(
            nice_duration(360365.254,
                          resolution=TimeResolution.MILLISECONDS,
                          speech=False),
            "4d 4:06:05.254",
        )
        ...
        self.assertEqual(nice_duration(0, resolution=TimeResolution.MINUTES),
                         "zero minutes")
        self.assertEqual(nice_duration(30, resolution=TimeResolution.MINUTES),
                         "under a minute")
    ...
    def test_nice_duration_dt(self):
        ...
        self.assertEqual(
            nice_duration_dt(datetime.datetime(2019, 1, 1),
        ...
        self.assertEqual(
            nice_duration_dt(datetime.datetime(2019, 1, 2),
                             date2=datetime.datetime(2018, 1, 1)),
            "one year one day",
        )

        self.assertEqual(
            nice_duration_dt(datetime.datetime(1, 1, 1),
