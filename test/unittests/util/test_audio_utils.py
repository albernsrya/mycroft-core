...
from mycroft.util import play_audio_file, play_mp3, play_ogg, play_wav, record
...
class TestPlaySounds(TestCase):
    ...
    def test_play_ogg_file_not_found(self, mock_log, mock_subprocess,
                                     mock_conf):
    ...
    @mock.patch("mycroft.util.audio_utils.LOG")
    def test_play_mp3_file_not_found(self, mock_log, mock_subprocess,
                                     mock_conf):
        """Test that simple log is raised when subprocess can't find command."""
        def raise_filenotfound(*arg, **kwarg):
            raise FileNotFoundError("TEST FILE NOT FOUND")
    ...
    @mock.patch("mycroft.util.audio_utils.LOG")
    def test_play_wav_file_not_found(self, mock_log, mock_subprocess,
                                     mock_conf):
        """Test that simple log is raised when subprocess can't find command."""
        def raise_filenotfound(*arg, **kwarg):
            raise FileNotFoundError("TEST FILE NOT FOUND")
