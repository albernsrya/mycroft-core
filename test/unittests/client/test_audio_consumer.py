...
from mycroft.client.speech.listener import (AUDIO_DATA, STREAM_DATA,
                                            STREAM_START, STREAM_STOP,
                                            AudioConsumer, RecognizerLoop)
...
class AudioConsumerTest(unittest.TestCase):
    ...
    def test_wakeword(self):
        self.queue.put(
            (AUDIO_DATA, self.__create_sample_from_test_file("mycroft")))
    ...
    def test_stop(self):
        ...
        self.queue.put(
            (AUDIO_DATA, self.__create_sample_from_test_file("stop")))
    ...
    def test_record(self):
        ...
        self.queue.put(
            (AUDIO_DATA, self.__create_sample_from_test_file("record")))
