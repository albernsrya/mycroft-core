...
from lingua_franca.format import (NUMBER_TUPLE, DateTimeFormat,
                                  _translate_word, date_time_format,
                                  expand_options, join_list, nice_date,
                                  nice_date_time, nice_number, nice_time,
...
def _duration_handler(time1,
    ...
    if speech:
        ...
        # if we have seconds but no minutes...
              ...
              or clock) and resolution.value > TimeResolution.MINUTES.value:
