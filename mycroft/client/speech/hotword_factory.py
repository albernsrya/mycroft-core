...
from mycroft.configuration import USER_CONFIG, Configuration, LocalConf
    ...
    def update_precise(self, precise_config):
        ...
        while not precise_exe:
            try:
                ...
                LOG.error("Precise could not be downloaded({})".format(
                    repr(e)))
    ...
    def update(self, chunk):
        ...
        while True:
            if len(self.audio_buffer) >= self.porcupine.frame_length:
                ...
                self.audio_buffer = self.audio_buffer[self.porcupine.
                                                      frame_length:]
            else:
                return
