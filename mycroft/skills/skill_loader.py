...
def _get_last_modified_time(path):
    ...
    for root_dir, dirs, files in os.walk(path):
        ...
        for f in files:
            ignore_file = (f.endswith(".pyc") or f == "settings.json"
                           or f.startswith(".") or f.endswith(".qmlc"))
            if not ignore_file:
...
class SkillLoader:
    ...
    def reload_needed(self):
        ...
        reload_allowed = self.active and (instance is None
                                          or instance.reload_skill)
    ...
    def _garbage_collect(self):
        ...
        if refs > 0:
            log_msg = ("After shutdown of {} there are still {} references "
    ...
    def _load_skill_source(self):
        ...
        if not os.path.exists(main_file_path):
            ...
            try:
                ...
                module_is_skill = hasattr(skill_module,
                                          "create_skill") and callable(
