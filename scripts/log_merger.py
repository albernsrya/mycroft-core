...
class LogFileReader:
    ...
    def _parse_log_msg_ts(self, log_msg_ts):
        try:
            ...
            print("Found log message with bad time section: " +
                  self.log_file_rec)
    ...
    def check_for_inclusion(self, earliest_ts, script_args):
        ...
        return (emitted_after_start_ts
                and (script_args.include is None or matches_inclusion_string)
                and
                (script_args.exclude is None or not matches_exclusion_string)
                and include_process)
...
class LogWriter:
    def __init__(self, script_args):
        ...
        self.start_ts = datetime.combine(script_args.start_date,
...
def _define_script_args():
    ...
    arg_parser.add_argument(
        "--start-time",
        default=time(0),
        help=("Time log messages were emitted format in HH:MM:SS format, "
    ...
    arg_parser.add_argument(
        "--exclude",
        action="append",
        help=("Do not show log messages containing this string.  If this "
    ...
    arg_parser.add_argument(
        "--file",
        help=("Name of file log messages will be written to.  Log messages "
